...
NFR-1.3 & The system shall validate an interview-generation request for between 1 and 50 questions (default 5) against its selected outcomes and source scope. Generation performance and outcome-coverage targets require measured acceptance evidence before they are stated as satisfied. & Teachers & Yes & Partial & Medium \\ \hline
