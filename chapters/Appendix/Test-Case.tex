...
TC-5.4.1 & FR-5.4 & System & Eligible student starts a hybrid interview and submits a typed turn & The hybrid session starts and the typed turn is associated with its session question & Student is denied entry if interview prerequisites are not satisfied \\ \hline
TC-5.4.2 & FR-5.4 & System & Eligible student enables microphone interaction where the voice runtime is deployed & The same hybrid room supports spoken turns when rollout controls permit & The client shows guidance while typed interaction remains available if microphone permission is denied \\ \hline
