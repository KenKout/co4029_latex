...
\texttt{GET} & \path|/management/learning-programs/{program\_id}/students| & Enrolment roster with each student's selected path and progress. \\ \hline
...
\texttt{GET} & \path|/management/learning-programs/{program\_id}/path-change-requests| & Pending and decided path-change requests for dean review. \\ \hline
...
\texttt{POST} & \path|/management/learning-programs/path-change-requests/{request\_id}/approve| & Approve; transfers progress and re-grants entitlements for shared courses. \\ \hline
...
\texttt{POST} & \path|/me/learning-program-enrollments/{enrollment\_id}/select-path| & Choose the initial career path within an enrolled programme. \\ \hline
...
\texttt{DELETE} & \path|/me/learning-program-enrollments/path-change-requests/{request\_id}| & Cancel one's own pending request before it is decided. \\ \hline
