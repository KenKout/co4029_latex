...
This appendix carries the two algorithm specifications the body of the report
states only in summary. The first is the spaced-repetition scheduling model,
given here in full; the second is the flow of the career-pathway stage
evaluation whose rules are specified in Section~\ref{sec:pathway_completion}.
