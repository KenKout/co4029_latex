...
FR-7.14 & The system shall allow a Student to add further career pathways from those pinned in their programme version without approval, up to a per-programme limit that may exceed neither the number of pathways attached to that programme nor an organisation-configurable ceiling, and shall refuse a pathway that is already held or that lies outside the enrolled version. & Students & UR-STU-01 & Yes & Yes & Medium \\ \hline
