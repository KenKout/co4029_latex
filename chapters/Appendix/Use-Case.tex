...
\textbf{Description} & Describes the life of a Student's career pathways within an enrolled learning programme: the default pathway they receive on enrolment, the further pathways they may add without approval, and the two reviewed requests --- to change a pathway or to drop one --- which an owning Faculty Dean acknowledges and then approves or rejects. \\ \hline
\textbf{Pre-conditions} &
...
\textbf{Post-conditions} &
$\bullet$ Upon enrolment the enrolment is active with an open attempt pinned to the version of the programme's default pathway. \newline
...
\textbf{Main Flow} &
1. On enrolment the system activates the enrolment, opens an attempt pinned to the version of the programme's default pathway, records the assignment as system-originated, and grants access to that pathway's courses. \newline
