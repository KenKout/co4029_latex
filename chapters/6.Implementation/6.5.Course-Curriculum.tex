...
\diagramplaceholder{fig:impl_course_tree}{Course curriculum structure and publication states}{Show the course $\rightarrow$ module $\rightarrow$ item tree with the uniform item abstraction over lessons, quizzes and interviews; alongside it, the \texttt{draft} $\rightarrow$ \texttt{published} $\rightarrow$ \texttt{archived} state machine and which transitions are reversible. Mark the point at which content becomes visible to learners.}
