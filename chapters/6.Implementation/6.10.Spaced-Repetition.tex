...
\diagramplaceholder{fig:impl_sm2_cycle}{SM-2 review scheduling cycle}{A flow chart from a graded answer to the next due date: quality derivation, ease-factor update, interval computation, and the jitter applied to prevent cohort pile-up. Show the lapse branch taken on an incorrect answer, and the unlock evaluation that reads the resulting card state.}
